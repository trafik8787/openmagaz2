                ...
                <div class="one-product-info" id="product">
                    ...
                    <div class="product-advantages">
                        ...
                        <div class="product-advantages-list clearfix">
                            ...
                            <div class="product-advantages-col">
                                <div class="product-advantages-item">
                                    <div class="product-advantages-item-img"><img src="/catalog/view/theme/canary/img/p-advantage-5.png" alt=""></div>
                                    <div class="product-advantages-item-text">Made in USA</div>
                                </div>
                                <div class="product-advantages-item">
                                    <div class="product-advantages-item-img"><img src="/catalog/view/theme/canary/img/p-advantage-6.png" alt=""></div>
                                    <div class="product-advantages-item-text">Free Sizing</div>
                                </div>
                            </div>
                            <div class="product-advantages-col">
                                <div class="product-advantages-item">
                                    <div class="product-advantages-item-img"><img src="/catalog/view/theme/canary/img/p-advantage-7.png" alt=""></div>
                                    <div class="product-advantages-item-text">Free Appraisal</div>
                                </div>
                                <div class="product-advantages-item">
                                    <div class="product-advantages-item-img"><img src="/catalog/view/theme/canary/img/p-advantage-8.png" alt=""></div>
