...
<main class="w-general-container">
    ...
    <div class="margin-buttom-30 w-bredcrum-border">
       <div class="center-bl">
           <div class="row">
               <span href="#" class="w-acsia-shild" data-toggle="modal" data-target="#ModalAkcia"><img src="/catalog/view/theme/canary/img/demo_new_template/akcia.png" alt="briliantcanary"></span>
