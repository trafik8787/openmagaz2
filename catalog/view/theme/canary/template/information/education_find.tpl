...
<script>
    $(function () {
        ...
        hash && $('a.fine-link[href="' + hash + '"]').tab('show').addClass('active');
    });
</script>
...
<main class="w-general-container">
    ...
    <div class="fine-page">
        <div class="title">Education Center</div>
        <div class="under-title">Loose diamonds</div>
        ...
        <div id="engagement_rings" class="new-products fine-tab">
            <div class="panel product-tabs panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                ...
                <div class="panel-body product-panel-body center-bl">
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="ringTypes">
                            <div class="box-setting-tab box-types-tab">
                                <div class="one-line-s">
                                    <div class="box-ws">
                                    </div>
                                    <div class="title-ws">Ring Types</div>
                                    <p>
                                        One of the most important steps in buying an engagement ring is determining your ring type
                                    </p>
                                </div>
                                <div class="one-line-s">
                                    <div class="box-ws">
                        ...
                        <div class="tab-pane fade" id="ringSizing">
                        ...
                        <div class="tab-pane fade" id="metals">
                            <div class="box-ring-fine clearfix">
                                ...
                                <div class="one-block-r">
                                    <div class="box-ring">
                                        <img src="catalog/view/theme/canary/img/fine/img19.png" alt="img">
                                    </div>
                                    platinum
                                </div>
                                <div class="one-block-r">
                            ...
                            <div class="block-p">
                                <div class="article-p">Metals</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">White Gold Engagement Rings</div>
                                <p>
                                    White gold is an incredibly beautiful and popular choice for engagement ring settings, which is quickly becoming the number one choice in engagement ring metals.  offers white gold in 14K and 18K. 14K gold contains 58.5% gold, while 18K white gold is made up of 75% gold and 25% other metals (nickel, zinc, etc). White gold has the overall look of platinum, but is notably less expensive. White gold beautifully compliments diamonds that are rated D-I on the diamond color scale, as it enhances the brilliance and sparkle of the stone.
                                </p>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Caring For White Gold Jewelry</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Yellow Gold Engagement Rings</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Caring For Yellow Gold Jewelry</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Platinum Engagement Rings</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Caring for Platinum Engagement Rings</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Rose Gold Engagement Rings</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Caring For Rose Gold Jewelry</div>
                                <p>
                        ...
                        <div class="tab-pane fade" id="budget">
                            <div class="sapphires-tab-box clearfix">
                                <div class="one-sapphires">
                                    ...
                                    <p>
                                        Buying an engagement ring is an exciting process. With  you can buy an engagement ring within your budget, from the comfort of your home or mobile device.
                                    </p>
                                    <p>
                                        Here are some basic guidelines on how to buy an engagement ring on a budget:
                                    </p>
                                    <div class="article">A Diamond Certificate Doesn’t Tell You the Whole Story</div>
                                    <p>
                                    ...
                                    <p>
                                        At , our diamonds are presented in stunning Diamond Display Technology, so you know exactly what you’re getting. Seeing actual diamond photos puts you in control of the purchase process and gives you the confidence of knowing that you’re getting the best diamond for your money.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="perfectRing">
                            <div class="sapphires-tab-box clearfix">
                                <div class="one-sapphires">
                                    <div class="box-img2">
                                    ...
                                    <div class="article">The 4Cs of Diamond Quality</div>
                                    <p>
                                    ...
                                    <div class="article">Select Your Metal First</div>
                                    <p>
                                    ...
                                    <div class="article">Choose Your Setting Wisely</div>
                                    <p>
                                    ...
                                    <p>
                                        Once you have chosen the setting and diamond, your work is done.  will then prepare your perfect engagement ring and have it ready for you to present to your beloved as you ask for her hand in marriage.
                                    </p>
                                    <div class="article">Certificate of Appraisal</div>
                                    <p>
                                        Upon purchasing your diamond and setting, you will receive a certificate of authenticity. This certificate will confirm the engagement ring's value and is what you will need if you choose to insure your purchase. Most certificates are issued by the American Gem Society (A.G.S.) or the Gemological Institute of America (G.I.A.), two of the most widely accepted certifying organizations for the diamond industry. All of ’s diamonds come with certificates of appraisal. Do not purchase a diamond if it does not come with a certificate from a reputable.
                                    </p>
                                    <div class="article">A Guarantee or Warranty</div>
                                    <p>
                        ...
                        <div class="tab-pane fade" id="manufacturing">
                            <div class="block-p">
                                <div class="article-p">Ring Manufacturing</div>
                            </div>
                            ...
                            <div class="block-p">
                                <div class="article-p">Ring Manufacturing</div>
                                <p>
                                    This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.rsion  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra, erat sed fermentum feugiat, velit mauris egestas quam, ut aliquam massa nisl quis neque. Suspendisse in orci enim.
                                </p>
                            </div>
                            <div class="block-p">
                                <div class="article-p">Jewele Making</div>
                                <p>
        ...
        <div id="wedding_rings" class="new-products fine-tab">
            <div class="panel product-tabs panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                ...
                <div class="panel-body product-panel-body center-bl">
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="weddingRing">
                            <div class="block-p">
                                <div class="article-p">Wedding Ring Styles</div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="alternativeMetals">
                            <div class="block-p">
                                <div class="article-p">Alternative Metals</div>
                            </div>
                            ...
                            <div class="block-p">
                                <div class="article-p">Titanium</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Cobalt Chrome</div>
                                <p>
                            ...
                            <div class="block-p">
                                <div class="article-p">Ceramic</div>
                                <p>
                                    Ceramic rings have become more prevalent because of their durability, affordability and wide range of colors. The most popular ceramic wedding ring color is black, offering a sleek and unique look for a wedding band. Ceramic jewelry is also very versatile, as it can be customized into a variety of shapes and sizes.
                                </p>
                            </div>
                            <div class="block-p">
                                <p>
                                    To learn more about traditional metal types, click here.
                                </p>
                            </div>
                        ...
                        <div class="tab-pane fade" id="perfectWeddingRing">
                            <div class="block-p">
                            ...
                            <div class="block-p">
                                <div class="article-p">Traditional, Contemporary, or Both?</div>
                                <p>
        ...
        <div id="gamestones" class="new-products fine-tab">
            <div class="panel product-tabs panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                ...
                <div class="panel-body product-panel-body cs-tab center-bl">
                    <div class="tab-content">
                        <div class="tab-pane fade" id="anatomy">
                            <div class="sapphires-tab-box clearfix">
                                <div class="sapphires-link-box">
                                    ...
                                    <a href="#" class="sapphires-link" data-target="#csTab2">
                                        DIAMOND PROPORTION
                                    </a>
                                    <a href="#" class="sapphires-link" data-target="#csTab3">
                                        DIAMOND SYMMETRY
                                    </a>
                                    <a href="#" class="sapphires-link" data-target="#csTab4">
                                        DIAMOND POLISH
                                    </a>
                                    <a href="#" class="sapphires-link" data-target="#csTab5">
                        ...
                        <div class="tab-pane fade" id="idealCut">
                            <div class="sapphires-tab-box clearfix">
                                <div class="sapphires-link-box">
                                    <a href="#" class="sapphires-link ideal-cut active" data-target="#idealCutTab1">
                                        IDEAL CUT DIAMONDS
                                    </a>
                                    <a href="#" class="sapphires-link ideal-cut" data-target="#idealCutTab2">
                                        TRUE HEARTS
                                    </a>
                                </div>
                                <div id="idealCutTab1" class="one-ideal-cut active">
                                    <div class="block-p">
                                        <div class="article-p">Proportion – Understanding Brilliance, Dispersion &amp; Scintillation</div>
                                        <p>
                                            This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.
                                ...
                                <div id="idealCutTab2" class="one-ideal-cut">
                                    <div class="block-p">
                        ...
                        <div class="tab-pane fade" id="fancyColor">
                            <div class="sapphires-tab-box clearfix">
                                <div class="sapphires-link-box">
                                    <a href="#" class="sapphires-link fancy-color active" data-target="#fancyColorTab1">
                                        COLOR & INTENSITY
                                    </a>
                                    <a href="#" class="sapphires-link fancy-color" data-target="#fancyColorTab2">
                                        FANCY YELLOW
                                    </a>
                                    <a href="#" class="sapphires-link fancy-color" data-target="#fancyColorTab3">
                                        FANCY PINK
                                    </a>
                                    <a href="#" class="sapphires-link fancy-color" data-target="#fancyColorTab4">
                                        FANCY GREEN
                                    </a>
                                    <a href="#" class="sapphires-link fancy-color" data-target="#fancyColorTab5">
                                        FANCY BLUE
                                    </a>
                                    <a href="#" class="sapphires-link fancy-color" data-target="#fancyColorTab6">
                                        FANCY ORANGE
                                    </a>
                                    <a href="#" class="sapphires-link fancy-color" data-target="#fancyColorTab7">
                                        FANCY BROWN
                                    </a>
                                </div>
                                <div id="fancyColorTab1" class="one-fancy-color active">
                                    <div class="block-p">
                                ...
                                <div id="fancyColorTab2" class="one-fancy-color">
                                    ...
                                    <form action="" class="form-fancy">
                                        ...
                                        <button class="search-fancy"><i class="search-ico"></i></button>
                                    </form>
                                    <div class="block-p">
                                        <div class="article-p">Fancy yellow diamond</div>
                                        <p>
                                ...
                                <div id="fancyColorTab3" class="one-fancy-color">
                                    ...
                                    <div class="block-p">
                                        <div class="article-p">Fancy pink diamond</div>
                                        <p>
                                            This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.
                                        </p>
                                    </div>
                                ...
                                <div id="fancyColorTab4" class="one-fancy-color">
                                    ...
                                    <div class="block-p">
                                        <div class="article-p">Fancy green diamond</div>
                                        <p>
                                            This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.
                                        </p>
                                    </div>
                                ...
                                <div id="fancyColorTab5" class="one-fancy-color">
                                    ...
                                    <div class="block-p">
                                        <div class="article-p">Fancy blue diamond</div>
                                        <p>
                                            This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.
                                        </p>
                                    </div>
                                ...
                                <div id="fancyColorTab6" class="one-fancy-color">
                                    ...
                                    <div class="block-p">
                                        <div class="article-p">Fancy orange diamond</div>
                                        <p>
                                            This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.
                                        </p>
                                    </div>
                                ...
                                <div id="fancyColorTab7" class="one-fancy-color">
                                    ...
                                    <div class="block-p">
                                        <div class="article-p">Fancy brown diamond</div>
                                        <p>
                                            This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit.
                                        </p>
                                    </div>
                            ...
                            <div class="sapphires-tab-box clearfix">
                                ...
                                <div id="gradingTab2" class="one-grading">
                                    <div class="one-line text-left">
                                        ...
                                        <div>
                                            <div class="block-p">
                                                <div class="article-p">Why is a Grading Certificate Not Enough?</div>
                                                <p>
                                                    A diamond certificate verifies each diamond’s specifications, including its color grade, carat weight, clarity grade and cut grade. You should never buy a diamond without a diamond certificate. The most well-known grading laboratories are the Gemological Institute Why is a Grading Certificate Not Enough?
                                                </p>
                                            </div>
                                            <div class="block-p">
                                                <p>
                                                    ...
                                                    <br/><br/>
                                                    B) 1.01 Carat H-SI2 Excellent Cut Round Diamond
                                                    <br/><br/>
                                                    Click to see the certificate
                                                </p>
                                            </div>
                                ...
                                <div id="gradingTab4" class="one-grading">
                                    <div class="one-line text-left">
                                        ...
                                        <div>
                                            <div class="block-p">
                                                <div class="article-p">Eye Clean Diamonds</div>
                                            </div>
                                            <div class="block-p">
                                                <p>
                                            ...
                                            <div class="block-p">
                                                <p>
                                                    considers a diamond eye clean if the diamond appears to be free of inclusions when viewed face up in daylight (or fluorescent lighting) by the naked eye (with 20/20 vision) from a relatively short distance (6-12 inches).
                                                </p>
                                            </div>
                                            <div class="block-p">
                                                <p>
                                                    The concept of an eye clean diamond varies slightly in definition from retailer to retailer, but three major factors influence thedefinition of eye clean diamonds:
                                                </p>
                                            </div>
                                            <div class="block-p">
                                                <p>
                        ...
                        <div class="tab-pane fade in active" id="forCS">
                            <div class="sapphires-tab-box clearfix">
                                <div class="sapphires-link-box">
                                    ...
                                    <a href="#" class="sapphires-link choose-perfect" data-target="#choosePerfectTab2">
                                        COLOR
                                    </a>
                                    <a href="#" class="sapphires-link choose-perfect" data-target="#choosePerfectTab3">
                                        CLARITY
                                    </a>
                                    <a href="#" class="sapphires-link choose-perfect" data-target="#choosePerfectTab4">
                                        CARAT WEIGHT
                                    </a>
                                </div>
                                ...
                                <div id="choosePerfectTab3" class="one-choose-perfect">
                                    <div class="text-left">
                                        <div class="block-p">
