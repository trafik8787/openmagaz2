                ...
                <div class="clearfix">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        ...
                        <ul class="style-br-long w-margin-li">
                            ...
                            <li><a href="<?php echo $categories[3]['children'][7]['href']?>" class="w-general-category"><span class="wrap-ico2"><i class="own-b own-b-12" style="background-position-y: -7px;"></i></span> <span><?php echo $categories[3]['children'][7]['name']?></span></a></li>
