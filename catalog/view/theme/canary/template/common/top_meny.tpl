                ...
                <div class="clearfix">
                    <div class="jewelry-wrapper">
                        ...
                        <ul class="brilliant-style jewelry-style1">
                            ...
                            <li>
                                <a href="/fine-jewelry/diamond_studs" class="w-general-category"><span><i class="own-b own-b-1"></i></span><br/>Diamond<br/>studs</a>
                            </li>
                            <li>
                                <a href="/fine-jewelry/diamond_pendants" class="w-general-category"><span><i class="own-b own-b-4"></i></span><br/>Diamond<br/>pendant</a>
                            </li>
                        </ul>
                    </div>
                </div>
