            ...
            <div id="collapse-m1" class="panel-collapse collapse" role="tabpanel">
                <div class="panel-body">
                    <ul class="brilliant-style clearfix">
                        ...
                        <li>
                            <a href="/diamonds?&shape=Emerald" class="w-general-category"><span class="box-ico"><i class="brilliant-ico2 brilliant-s10"></i></span><span>Emerald Cut</span></a>
                        </li>
                        <li>
            ...
            <div id="collapse-m6" class="panel-collapse collapse" role="tabpanel">
                <div class="panel-body">
                    ...
                    <ul class="brilliant-style gemstones-box">
                        <li>
                            <a href="/gemstones&stone_type_gem=1"><i class="gemstones gemstones1"></i><span>blue sapphire</span></a>
                        </li>
                        <li>
                            <a href="/gemstones&stone_type_gem=5"><i class="gemstones gemstones2"></i><span>pink sapphire</span></a>
                        </li>
                        <li>
                            <a href="/gemstones&stone_type_gem=4"><i class="gemstones gemstones3"></i><span>yellow sapphire</span></a>
                        </li>
                        <li>
                            <a href="/gemstones&stone_type_gem=2"><i class="gemstones gemstones4"></i><span>red ruby</span></a>
                        </li>
                        <li>
                            <a href="/gemstones&stone_type_gem=3"><i class="gemstones gemstones5"></i><span>green emerald</span></a>
                        </li>
                    </ul>
