<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    <div class="form-group required">
      ...
      <div class="col-sm-9">
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="shipping-input" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-3 control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>
      <div class="col-sm-9">
        <input type="text" name="lastname" value="" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="shipping-input" />
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label" for="input-payment-company"><?php echo $entry_company; ?></label>
      <div class="col-sm-9">
        <input type="text" name="company" value="" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="shipping-input" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-3 control-label" for="input-payment-address-1"><?php echo $entry_address_1; ?></label>
      <div class="col-sm-9">
        <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address-1" class="shipping-input" />
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-3 control-label" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
      <div class="col-sm-9">
        <input type="text" name="address_2" value="" placeholder="<?php echo $entry_address_2; ?>" id="input-payment-address-2" class="shipping-input" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-3 control-label" for="input-payment-city"><?php echo $entry_city; ?></label>
      <div class="col-sm-9">
        <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="shipping-input" />
      </div>
    </div>
    <div class="form-group required">
      <label class="col-sm-3 control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
      <div class="col-sm-9">
        <input type="text" name="postcode" value="" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="shipping-input" />
      </div>
    </div>
    <div class="form-group required">
