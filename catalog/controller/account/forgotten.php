...
//			$message .= $password;
            ...
            $data_text_email['password'] = $password;
            $data_text_email['config_name'] = $this->config->get('config_name');
            $data_email['message'] = $this->load->view($this->config->get('config_template') . '/template/mail/text_forgotten_email.tpl', $data_text_email);
