...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
		    //  dd($this->config->get('config_email'), true);

            $message = '<p>Name: '.$this->request->post['name'].'</p><p>E-mail: '.$this->request->post['email'].'</p><p>Phone: '.$this->request->post['phone'].'</p><p>Message: '.$this->request->post['enquiry'].'</p>';
